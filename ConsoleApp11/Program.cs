...
//var filteredDebtors = debtors.Where(d => d.Email.EndsWith("@rhyta.com") || d.Email.EndsWith("@dayrep.com")).ToList();
//foreach (var d in filteredDebtors)
//{
//    Console.WriteLine(d.Name);
//}

//3) Yashi 26 - dan 36 - ya qeder olan borclulari cixartmag - yeniden bax
//var filterDebtors = debtors.Where(d => d.BirthdayYear < 1998 || d.BirthdayYear > 1889);
//foreach(var d in filterDebtors)
//{
//    Console.WriteLine(d.Name);
//}

//4) Borcu 5000-den cox olmayan borclularic cixartmag
//var filterDebtors = debtors.Where(d => d.Debt > 5000);
//foreach (var d in filterDebtors)
//{
//    Console.WriteLine(d.Name);
//}
...
//var filterDebtors = debtors.Where(d => d.Name.Length > 18 || d.PhoneNumber.Count(c => c == '2' || c == '7') >= 2).ToList();
//foreach (var d in filterDebtors)
//{
//    Console.WriteLine(d.Name);
//}
...
//var filterDebtors = debtors.Where(d=>d.DateOfBirth.Month==12 || d.DateOfBirth.Month==1 || d.DateOfBirth.Month==2);
//foreach (var d in filterDebtors)
//{
//    Console.WriteLine(d.Name);
//}
